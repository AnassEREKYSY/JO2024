...
const { get_sports, get_sport, list_sports, list_pays, get_athletes, get_athlete, get_epreuves, get_epreuve, get_titres, get_titre } = require('../../controllers/public_views/public.controller');
